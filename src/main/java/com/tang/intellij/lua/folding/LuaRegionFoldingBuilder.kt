...
class LuaRegionFoldingBuilder : FoldingBuilderEx() {
    ...
    private val customFoldingBuilder = object : FoldingBuilderEx() {
        ...
        private fun addCustomFoldingRegionsRecursively(
    ...
    override fun getPlaceholderText(node: ASTNode, range: TextRange) =
        customFoldingBuilder.getPlaceholderText(node, range)

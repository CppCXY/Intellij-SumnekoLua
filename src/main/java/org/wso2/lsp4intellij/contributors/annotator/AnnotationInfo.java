...
// workaround copy from Annotation
public class AnnotationInfo {
    ...
    private List<AnnotationInfo.QuickFixInfo> myQuickFixes;
    ...
    private List<AnnotationInfo.QuickFixInfo> myBatchFixes;
    ...
    public void registerFix(@NotNull LocalQuickFix fix, @Nullable TextRange range, @Nullable HighlightDisplayKey key,
        ...
        myQuickFixes.add(new AnnotationInfo.QuickFixInfo(new LocalQuickFixAsIntentionAdapter(fix, problemDescriptor), range, key));
    }
    ...
    public void registerFix(@NotNull IntentionAction fix, @Nullable TextRange range, @Nullable final HighlightDisplayKey key) {
        range = notNullize(range);
        List<AnnotationInfo.QuickFixInfo> fixes = myQuickFixes;
        if (fixes == null) {
            myQuickFixes = fixes = new ArrayList<>();
        }
        fixes.add(new AnnotationInfo.QuickFixInfo(fix, range, key));
    }
    ...
    public <T extends IntentionAction & LocalQuickFix> void registerBatchFix(@NotNull T fix, @Nullable TextRange range, @Nullable HighlightDisplayKey key) {
        ...
        List<AnnotationInfo.QuickFixInfo> fixes = myBatchFixes;
        if (fixes == null) {
    ...
    @Nullable
    public List<AnnotationInfo.QuickFixInfo> getQuickFixes() {
        return myQuickFixes;
    }

    @Nullable
    public List<AnnotationInfo.QuickFixInfo> getBatchFixes() {
        return myBatchFixes;
    }

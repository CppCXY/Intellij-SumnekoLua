...
//        });
    ...
    @Nullable
    protected AnnotationInfo createAnnotation(Editor editor, AnnotationHolder holder, Diagnostic diagnostic) {
...
//        final TextRange range = new TextRange(start, end);
        ...
        return new AnnotationInfo(start, end,
                lspToIntellijAnnotationsMap.get(diagnostic.getSeverity()), diagnostic.getMessage(), null);
    }
    ...
    private void createAnnotations(AnnotationHolder holder, EditorEventManager eventManager) {
        ...
        diagnostics.forEach(d -> {
            AnnotationInfo annotation = createAnnotation(editor, holder, d);
            if (annotation != null) {
                ...
                TextRange range = new TextRange(annotation.getStartOffset(), annotation.getEndOffset());
                holder.newAnnotation(annotation.getSeverity(), annotation.getMessage())
                        .range(range)
                        .create();
            }
